...
public:
    ...
    void execute(Block & block, const ColumnNumbers & arguments, size_t result, size_t input_rows_count) override
    {
        ...
        block.getByPosition(result).column = DataTypeInt64().createColumnConst(input_rows_count, file_val);
    }
...
{
public:
    explicit FunctionBaseFileInc(const String & user_files_path_): user_files_path(user_files_path_) {}
...
public:
    ...
    FunctionBaseImplPtr build(const ColumnsWithTypeAndName & arguments, const DataTypePtr & return_type) const override
    {
        ...
        return std::make_unique<FunctionBaseFileInc>(user_files_path);
    }
